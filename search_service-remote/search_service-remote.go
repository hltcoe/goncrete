...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  SearchResult search(SearchQuery query)")
  fmt.Fprintln(os.Stderr, "   getCapabilities()")
  fmt.Fprintln(os.Stderr, "   getCorpora()")
...
func main() {
  ...
  client := goncrete.NewSearchServiceClientFactory(trans, protocolFactory)
  ...
  case "getCapabilities":
    if flag.NArg() - 1 != 0 {
      fmt.Fprintln(os.Stderr, "GetCapabilities requires 0 args")
      flag.Usage()
    }
    fmt.Print(client.GetCapabilities())
    fmt.Print("\n")
    break
  case "getCorpora":
    if flag.NArg() - 1 != 0 {
      fmt.Fprintln(os.Stderr, "GetCorpora requires 0 args")
      flag.Usage()
    }
    fmt.Print(client.GetCorpora())
    fmt.Print("\n")
    break
  case "about":
    if flag.NArg() - 1 != 0 {
