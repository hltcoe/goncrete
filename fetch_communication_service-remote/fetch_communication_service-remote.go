...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  FetchResult fetch(FetchRequest request)")
  fmt.Fprintln(os.Stderr, "   getCommunicationIDs(i64 offset, i64 count)")
  fmt.Fprintln(os.Stderr, "  i64 getCommunicationCount()")
...
func main() {
  ...
  client := goncrete.NewFetchCommunicationServiceClientFactory(trans, protocolFactory)
  ...
  case "fetch":
    ...
    argvalue0 := goncrete.NewFetchRequest()
    ...
    fmt.Print("\n")
    break
  case "getCommunicationIDs":
    if flag.NArg() - 1 != 2 {
      fmt.Fprintln(os.Stderr, "GetCommunicationIDs requires 2 args")
      flag.Usage()
    }
    ...
    value1 := argvalue1
    fmt.Print(client.GetCommunicationIDs(value0, value1))
    fmt.Print("\n")
    break
  case "getCommunicationCount":
    if flag.NArg() - 1 != 0 {
      fmt.Fprintln(os.Stderr, "GetCommunicationCount requires 0 args")
      flag.Usage()
    }
    fmt.Print(client.GetCommunicationCount())
    fmt.Print("\n")
    break
  case "about":
    if flag.NArg() - 1 != 0 {
