...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  void store(Communication communication)")
...
func main() {
  ...
  client := goncrete.NewStoreCommunicationServiceClientFactory(trans, protocolFactory)
  ...
  case "store":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "Store requires 1 args")
      flag.Usage()
    }
    arg21 := flag.Arg(1)
